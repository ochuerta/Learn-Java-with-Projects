...
public class Optionals {
    ...
    public static void createOptionals() {
        ...
        Optional<Integer> opt3 = Optional.ofNullable(23);
        opt3.ifPresent(o -> System.out.println("opt3: " + o));

        Optional<Object> opt4 = Optional.ofNullable(null);
    ...
    public static void doOptionalNull() {
        ...
        System.out.println(emptyOpt.orElseGet(() -> "Empty optional")); // Empty optional
    }
